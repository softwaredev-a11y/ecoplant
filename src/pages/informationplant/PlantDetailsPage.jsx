...
function PlantDetailsPage() {
    ...
    return (
        <div className="info-container flex flex-col p-4 overflow-y-auto">
            ...
            <PlantDetailSocketProvider plantId={plant.id} isOnline={infoConnectionDevice?.connection?.online}>
                <div className="info-containers gap-4 grid grid-cols-1 sm:grid-cols-[repeat(auto-fit,minmax(450px,1fr))]">
                    ...
                    <OperationsPanel plant={plant} isOnline={infoConnectionDevice.connection.online} />
