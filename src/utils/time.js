import { fillLeftText } from "./string";
...
export function getFormattedTime(unitTime, time) {
    let totalSeconds = getTime(unitTime, time);
 ...
 */
export function getTime(unitTime, time) {
    let totalSeconds = 0;
