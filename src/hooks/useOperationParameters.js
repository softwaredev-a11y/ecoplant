...
import { processSocketMessage, getMvZeroText } from '@/utils/syrus';
import { SYRUS3_COMMANDS, SOCKET_KEYS, HEADER_MESSAGES_SOCKET, COMMAND_STATES, SYRUS3_MESSAGE_HEADERS } from '@/constants/constants';
import { isScheduleMessage, extractScheduleMessageHeader, generateOperationHours, getSyrus4OperationHours } from '@/utils/operationHours';
import { proccessSyrus4SocketMessage } from '@/utils/syrus4';
